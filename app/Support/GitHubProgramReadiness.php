...
class GitHubProgramReadiness
{
    public static function report(): array
    {
        $checks = collect([
            ...
            self::check('Planos e modelo SaaS', Schema::hasTable('billing_plans') && BillingPlan::count() > 0, 'Modelo comercial por uso pode ser demonstrado no painel autenticado.', 'SaaS'),
            self::check('Docs para usuarios', view()->exists('docs.users') && view()->exists('docs.api'), 'Guia de uso e referencia tecnica para devs existem.', 'Docs'),
