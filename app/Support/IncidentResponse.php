...
class IncidentResponse
{
    public static function report(): array
    {
        ...
        $openBugs = Schema::hasTable('bug_reports') ? BugReport::open()->count() : 0;
        $criticalBugs = Schema::hasTable('bug_reports') ? BugReport::open()->where('level', 'critical')->count() : 0;
        ...
        $checks = collect([
            ...
            self::check('Monitor de bugs sem criticos', $criticalBugs === 0, $openBugs.' bug(s) aberto(s), '.$criticalBugs.' critico(s)', 'bugs'),
        ...
        $incidents = collect([
            ...
            ...($criticalBugs > 0 ? [[
                'severity' => 'critical',
                'title' => 'Bugs criticos abertos',
                'detail' => $criticalBugs.' bug(s) critico(s) capturado(s) pelo monitor interno.',
                'command' => 'Abrir /admin/bug-monitor',
            ]] : []),
            ...($openTickets >= 10 ? [[
                'severity' => 'medium',
