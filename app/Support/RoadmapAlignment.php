...
class RoadmapAlignment
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'Catalogo de qualidade de codigo e revisao continua' => self::meta('local', 'Proxima entrega', 'Testes automatizados e Pint existem no projeto, mas falta gate formal de qualidade.', 'Adicionar checklist de qualidade, comando preflight local e recomendacao de CI.', null),
