    ...
    <section class="home-hero">
      <div class="float-card">
        ...
        <div class="quick">
          ...
          <a href="{{ url('/admin/github-submission') }}">Submissao GitHub</a>
          <a href="{{ url('/admin/github-marketplace') }}">Marketplace GitHub</a>
          <a href="{{ url('/admin/launch-tests') }}">QA lancamento</a>
