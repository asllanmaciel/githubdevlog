<x-filament-panels::page>
  ...
  <div class="devlog-docs">
    ...
    <section class="docs-grid">
      ...
      <article class="docs-card"><div class="kicker">Marketplace</div><h3>Listagem do GitHub App</h3><p>Use o rascunho de Marketplace para revisar descricao, links, evidencias, screenshots e pendencias antes de publicar o app.</p><a href="{{ url('/admin/github-marketplace') }}">Ver rascunho</a></article>
